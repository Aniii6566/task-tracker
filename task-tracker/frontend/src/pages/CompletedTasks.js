...
const CompletedTasks = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-text-primary mb-2">Completed Tasks</h1>
        <p className="text-text-secondary">Review your completed tasks for today.</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {loading ? (
            ...
            <div className="col-span-full text-center py-8 text-text-secondary">
              ...
              <h3 className="text-lg font-medium text-text-primary mb-2">No completed tasks</h3>
